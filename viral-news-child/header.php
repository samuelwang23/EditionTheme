    ...
    <body <?php body_class(); ?>>
        ...
        <div id="vn-page">
            ...
            <header id="vn-masthead" class="vn-site-header">
                ...
                <div class="vn-header vn-<?php echo esc_attr($viral_news_main_header_text_color) ?>" style = "background-color: #2d2c2c;padding:0;">
                    <div class="vn-container">
                ...
                <nav id="vn-site-navigation" class="vn-main-navigation vn-<?php echo esc_attr($viral_news_nav_style) ?>">
                    <div class="vn-container">
                        <!--<div class="vn-header-search"><a href="#"><i class="mdi mdi-magnify" style = "color: e04a4aff !important;"></i></a></div>-->
                        <div class="vn-header-search"><i class="mdi mdi-magnify" style="color: red;"></i></div>
                        ...
                        wp_nav_menu(
                                array(
                                    ...
                                    'menu_class' => 'vn-clearfix Montserrat',
